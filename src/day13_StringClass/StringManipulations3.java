...
public class StringManipulations3 {
    ...
    public static void main(String[] args) {
        ...
        String str0 = "I like Java programing John";
        int num2 = str0.indexOf("John");
        ...
        int maxIndexnumber = "Vybertek".length()-1;     // 8-1
        System.out.println(maxIndexnumber);

        String name = "Muhtar";
        int indexNumber = name.indexOf("Good guy");
        System.out.println(indexNumber);  //  -1 ===> coz the given index is not exist in the String

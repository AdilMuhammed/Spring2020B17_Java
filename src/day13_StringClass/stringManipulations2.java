...
public class stringManipulations2 {
    ...
    public static void main(String[] args) {
        ...
        //            012345678
        String schoolName = str.substring(0,8);  // (0,8) given (beginen index, ending index
        ...
        //           0123456789 ......
        String className = s1.substring(7);  // it take from the beginning (7) index until the end index
        System.out.println(className);


        String s2 = "I like C# Programing Language";
